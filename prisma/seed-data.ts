...
async function main() {
  ...
  // Create metrics for sample projects
  const metricsData = [
    {
      portfolioProjectId: "denver-united-soccer-club", // This would be the actual ID from the database
      trafficIncrease: "+250%",
      conversionRate: "12%",
      pageLoadSpeed: "1.2s",
      mobileScore: "95/100",
    ...
    {
      portfolioProjectId: "mountain-state-basketball-tournament",
      trafficIncrease: "+180%",
      conversionRate: "8%",
      pageLoadSpeed: "1.5s",
      mobileScore: "92/100",
    ...
    {
      portfolioProjectId: "colorado-youth-hockey-league",
      trafficIncrease: "+200%",
      conversionRate: "10%",
      pageLoadSpeed: "1.8s",
      mobileScore: "90/100",
  ...
  // Note: In a real implementation, you'd need to get the actual project IDs first
